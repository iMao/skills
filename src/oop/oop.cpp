...
//    Stock stock5 = Stock("GP Morgan"); //явный вызов конструктора с
//    параметрами Stock stock6 = Stock("IBM", 100, 15.5); Stock
//    stock7("Microsoft", 45, 10.0); Stock stock8{"BP", 150,
...
//  //динамическое связывание через объект базового класса передаваемый в
//  функцию
//  //по ссылке
//  {
//    Char oChar('x');
...
////------------------------------------
// unsigned int graph_object::counter; //определение статической переменной
// класса
//                                    // graph_object
